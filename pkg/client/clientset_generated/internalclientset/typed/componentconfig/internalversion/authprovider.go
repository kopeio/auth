...
type AuthProviderInterface interface {
	Create(*componentconfig.AuthProvider) (*componentconfig.AuthProvider, error)
	Update(*componentconfig.AuthProvider) (*componentconfig.AuthProvider, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*componentconfig.AuthProvider, error)
	List(opts v1.ListOptions) (*componentconfig.AuthProviderList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *componentconfig.AuthProvider, err error)
...
func newAuthProviders(c *ComponentconfigClient, namespace string) *authProviders {
...
func (c *authProviders) Create(authProvider *componentconfig.AuthProvider) (result *componentconfig.AuthProvider, err error) {
	result = &componentconfig.AuthProvider{}
	err = c.client.Post().
		Namespace(c.ns).
...
func (c *authProviders) Update(authProvider *componentconfig.AuthProvider) (result *componentconfig.AuthProvider, err error) {
	result = &componentconfig.AuthProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("authproviders").
...
func (c *authProviders) Get(name string, options v1.GetOptions) (result *componentconfig.AuthProvider, err error) {
	result = &componentconfig.AuthProvider{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("authproviders").
...
func (c *authProviders) List(opts v1.ListOptions) (result *componentconfig.AuthProviderList, err error) {
	result = &componentconfig.AuthProviderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("authproviders").
...
func (c *authProviders) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *componentconfig.AuthProvider, err error) {
	result = &componentconfig.AuthProvider{}
