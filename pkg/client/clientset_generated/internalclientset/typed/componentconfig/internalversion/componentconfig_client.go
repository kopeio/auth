...
func NewForConfig(c *rest.Config) (*ComponentconfigClient, error) {
	config := *c
	...
	return &ComponentconfigClient{client}, nil
}

// NewForConfigOrDie creates a new ComponentconfigClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ComponentconfigClient {
...
// New creates a new ComponentconfigClient for the given RESTClient.
func New(c rest.Interface) *ComponentconfigClient {
	return &ComponentconfigClient{c}
}
...
func (c *ComponentconfigClient) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
