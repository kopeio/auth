...
type Options struct {
	...
	SkipAuthRegex      []string `flag:"skip-user-regex" cfg:"skip_auth_regex"`
	PassBasicAuth      bool     `flag:"pass-basic-user" cfg:"pass_basic_auth"`
	BasicAuthPassword  string   `flag:"basic-user-password" cfg:"basic_auth_password"`
