...
class ConfigAuthProviderComponent extends FormComponent {

  constructor(props) {
    super(props, AuthProviders.namespace("default"), props.name);
  }
...
export default ConfigAuthProviderComponent;